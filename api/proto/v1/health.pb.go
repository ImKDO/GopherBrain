...
type HealthCheckResponse struct {
	state         protoimpl.MessageState            `protogen:"open.v1"`
	Status        HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=gopherbrain.v1.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_health_proto_rawDesc = "" +
	"\n" +
	"\fhealth.proto\x12\x0egopherbrain.v1\".\n" +
	"\x12HealthCheckRequest\x12\x18\n" +
	"\aservice\x18\x01 \x01(\tR\aservice\"\x9c\x01\n" +
	"\x13HealthCheckResponse\x12I\n" +
	"\x06status\x18\x01 \x01(\x0e21.gopherbrain.v1.HealthCheckResponse.ServingStatusR\x06status\":\n" +
	"\rServingStatus\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\v\n" +
	"\aSERVING\x10\x01\x12\x0f\n" +
	"\vNOT_SERVING\x10\x022Z\n" +
	"\x06Health\x12P\n" +
	"\x05Check\x12\".gopherbrain.v1.HealthCheckRequest\x1a#.gopherbrain.v1.HealthCheckResponseB0Z.github.com/ImKDO/GopherBrain/api/proto/v1;pbv1b\x06proto3"
...
var file_health_proto_goTypes = []any{
	(HealthCheckResponse_ServingStatus)(0), // 0: gopherbrain.v1.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: gopherbrain.v1.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: gopherbrain.v1.HealthCheckResponse
}
var file_health_proto_depIdxs = []int32{
	0, // 0: gopherbrain.v1.HealthCheckResponse.status:type_name -> gopherbrain.v1.HealthCheckResponse.ServingStatus
	1, // 1: gopherbrain.v1.Health.Check:input_type -> gopherbrain.v1.HealthCheckRequest
	2, // 2: gopherbrain.v1.Health.Check:output_type -> gopherbrain.v1.HealthCheckResponse
